...
const PricingCustom = ({ onOpenProto }) => {
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: 'var(--bg)', padding: '28px 40px', display: 'flex', flexDirection: 'column', gap: 18, overflow: 'hidden' }}>
      <div>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 18, minHeight: 0 }}>
        <div className="scroll" style={{ display: 'flex', flexDirection: 'column', gap: 10, paddingRight: 6 }}>
          {MODULES.map(m => {
        ...
        <div className="card dark" style={{ padding: 22, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <div className="scroll" style={{ flex: 1, minHeight: 0, margin: '10px 0' }}>
...
const CaptureChecklistV2 = ({ onSubmit }) => {
  const b = useBundle();
  return (
    <div style={{ width: '100%', height: '100%', background: 'var(--bg)', padding: '28px 40px', display: 'flex', flexDirection: 'column', gap: 16, overflow: 'hidden' }}>
      <div>
      ...
      <div className="scroll" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 10 }}>
        {MODULES.map(m => {
          const subs = subsByParent(m.id);
